  ...
  defmacro __using__(_) do
    quote do
      ...
      def handle_call({ :get_all }, _from, _state) do
        all = TpSubastas.Repo.all(Comprador)
      ...
      def handle_call({ :get, id_comprador }, _from, _state) do
        struct = TpSubastas.Repo.get!(Comprador, id_comprador)
      ...
      def handle_call({ :delete, id_comprador }, _from, _state) do
        comprador = TpSubastas.Repo.get!(Comprador, id_comprador)
        TpSubastas.Repo.delete!(comprador)
